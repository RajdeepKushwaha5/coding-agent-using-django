...
* Add the Google Gemini API key:
    ...
    * Name: `GOOGLE_API_KEY`, Secret: your key
    * Click "Add secret"
* Create a codespace
    * Click "Code" 
...
```bash
pip install jupyter django uv google-generativeai toyaikit
```


## Google Gemini API: Quick Recap
...
response = model.generate_content("Tell me a joke about Alexey.")
...
from toyaikit.chat.runners import GeminiResponsesRunner
